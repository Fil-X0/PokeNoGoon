...
u32 GetCurrentLevelCap(void)
{
    static const u32 sLevelCapFlagMap[][2] =
    {
        ...
        {FLAG_BADGE02_GET, 30},
        {FLAG_BADGE03_GET, 35},
        {FLAG_MUSEUM_GRUNT, 38},
        {FLAG_CYCLING_RIVAL, 41},
        {FLAG_BADGE04_GET, 44},
        {FLAG_OCEANE, 48},
        {FLAG_MAXIE_MT_CHIMNEY, 54},
        {FLAG_BADGE05_GET, 58},
        {FLAG_SHELLY_WINST, 65},
        {FLAG_BRIDGE_RIVAL, 67},
        {FLAG_BADGE06_GET, 70},
        {FLAG_LILYCOVE_RIVAL, 73},
        {FLAG_ARCHIE_MT_PYRE, 76},
        {FLAG_MAXIE_MHIDEOUT, 80},
        {FLAG_MATT_AHIDEOUT, 81},
        {FLAG_BADGE07_GET, 83},
        {FLAG_MAXIE_SPACE_CENTER, 86},
        {FLAG_ARCHIE_SEAFLOOR_CAVERN, 89},
        {FLAG_BADGE08_GET, 90},
        {FLAG_MATRAC, 95},
        {FLAG_IS_CHAMPION, 99},
    };
